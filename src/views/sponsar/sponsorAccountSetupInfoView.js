...
const sponsorAccountSetupInfoView = (props) => {
    ...
    function btnContinueClicked() {
        ...
        let objFirbaseEvent = {
            ...
            eventObject: {
                button: "sponsor_setup_account_continue"
            }
        }
    ...
    function onFAQClicked() {
        let objFirbaseEvent = {
            eventTitle: "button_clicked",
            eventObject: {
                button: "sponsor_faq_setup_account_screen"
            }
        }
        EventRegister.emit("logFirebaseEventListener", objFirbaseEvent)
            ...
            <View style={{ flex: 1, width: '100%', alignItems: 'center' }}>
                ...
                <View style={{ flex: 1, alignItems: 'center', padding: 10, marginTop: 0 }}>
                    <ScrollView>
                        ...
                        }}>{"SendMe allows you to set-up an account to support your favorite missionary. The application will track your transactions and round each up to the nearest dollar. Whatever this total adds up to will be sent to your selected missionary every other Friday if you have totaled at least $10. You can also send one-time payments for support in addition to the round-up process. Your missionary can post pictures and text updates so you can follow along with their journey. Our goal is to be the easiest way to connect with and support your missionary.\nFor more details check out our "}
                            <Text onPress={() => onFAQClicked()} style={{ color: Theme.colors.sendMeBlue, textDecorationLine: 'underline' }}>FAQs.</Text>
                            <Text>
                                {"\n\nStep 1 - Pick missionary\nStep 2 - Set-up Sponsor Profile\nStep 3 - Add Bank Account\nStep 4 - Use Same Bank Account or Add New Credit Card (for transaction round up)"}
                            </Text>
                        </Text>
                    </ScrollView>
                </View>
...
export default sponsorAccountSetupInfoView

sponsorAccountSetupInfoView['navigationOptions'] = screenProps => ({
    header: null
})
